...
require 'page_handler/allclaim_handler.php';
...
<div id="leftnavwrap">
	...
	<center>
<p align="LEFT"><a href="admin.php">Back</a></P>


<?php

   $query="SELECT * FROM `paymentapproved`";
...
<br><br><br>
 ...
 <form method="POST" action="allclaim.php">
EMPNO: <select  name="empselect">
<option value="Select">Select</option>
<?php
     $query1="SELECT DISTINCT(`empno`) FROM `paymentapproved`";
   ...
   ?>	  
       ...
       <option value="Select">Select</option>
<?php
     $query1="SELECT `sno` FROM `empclaimrequest`";
     if($query_run2=mysql_query($query1))
     {
       while($row2=mysql_fetch_assoc($query_run2))
       {

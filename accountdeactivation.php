...
require 'page_handler/accountdeactivation_handler.php';
...
<?php
  ...
  $activation=1;
   ...
   <br><br><br>
    ...
    <form method="POST" action="accountdeactivation.php">
ID&nbsp&nbsp:&nbsp&nbsp <select name="id">
...
$activated=1;
   ...
   ?>
      ...
      Username: <select  id="usernameoption" name="username" >
      <option value="Select">Select</option>
<?php
...
Status: <select name="activationstatus">
